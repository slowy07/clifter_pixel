...
if ["$IMAGENET_1024" = true]; then
  if [ ! -f  "$LOC"/vqgan_imagenet_f16_1024.yaml]; then
    curl -L -o "$LOC"/vqgan_imagenet_f16_1024.yaml -C - 'http://mirror.io.community/blob/vqgan/vqgan_imagenet_f16_1024.yaml'
  fi
  if [! -f "$LOC"/vqgan_imagenet_f16_1024.ckpt]; then
    curl -L -o "$LOC"/vqgan_imagenet_f16_1024.ckpt -C - 'http://mirror.io.community/blob/vqgan/vqgan_imagenet_f16_1024.ckpt'
  fi
fi

if ["$IMAGENET_16384" = true]; then
  if [ ! -f "$LOC"/vqgan_imagenet_f16_16384.yaml ]; then
    curl -L -o "$LOC"/vqgan_imagenet_f16_16384.yaml -C - 'http://mirror.io.community/blob/vqgan/vqgan_imagenet_f16_16384.yaml'
  fi
